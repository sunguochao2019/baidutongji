...
module.exports = {
  ...
  devServer: {
    ...
    proxy: {
      '/getSiteList/*': {
        target: 'https://api.baidu.com', // 代理接口地址
        secure: true,  // 如果是https接口，需要配置这个参数
        ws: true,
        changeOrigin: true, // 是否跨域
        pathRewrite: {
          '^/getSiteList/*': '/json/tongji/v1/ReportService/getSiteList'   //需要rewrite的, 这里理解成以'/api'开头的接口地址，把/api代替target中的地址
        },
      },
      '/getData/*': {
        target: 'https://api.baidu.com', // 代理接口地址
        ...
        changeOrigin: true, // 是否跨域
        pathRewrite: {
          '^/getData': '/json/tongji/v1/ReportService/getData'   //需要rewrite的, 这里理解成以'/api'开头的接口地址，把/api代替target中的地址
        },
      }
    },
